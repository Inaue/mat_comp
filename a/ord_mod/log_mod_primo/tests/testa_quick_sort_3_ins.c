/**
 * @file   testa_quicksort_3_ins.c
 * @brief  Testes para o quick sort com mediana de 3 com insertion sort.
...
int main()
{
	...
	quick_sort_3_ins(vi, 5, &t_int, 3);
	quick_sort_3_ins(vf, 8, &t_float, 2);
	quick_sort_3_ins(vc, 10, &t_char, 4);
